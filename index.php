                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">Unique Escrow <br> Protects <span>Your Interest</span></h2>
                                    <h5 data-animation="fadeInUp" data-delay="400ms">At unique escrow, we protect the buyer and make sure the transaction is secure and legit. We are here for you.</h5>
                                    <a href="authenticate.php" class="btn uza-btn btn-2" data-animation="fadeInUp" data-delay="700ms">Start A Transaction</a>
                                </div>
                            </div>
                            <!-- Welcome Thumbnail -->
                            <div class="col-12 col-md-6">
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">Always Start<br>  A transaction with <span>Unique Escrow</span></h2>
                                    <h5 data-animation="fadeInUp" data-delay="400ms"></h5>
                                    <a href="contact.php" class="btn uza-btn btn-2" data-animation="fadeInUp" data-delay="700ms">Contact Us</a>
                                </div>
                            </div>
                            <!-- Welcome Thumbnail -->
                            <div class="col-12 col-md-6">
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">We Cover  <br> Our Clients <span>In Every Transaction</span></h2>
                                    <h5 data-animation="fadeInUp" data-delay="400ms"></h5>
                                    <a href="services.php" class="btn uza-btn btn-2" data-animation="fadeInUp" data-delay="700ms">Start Exploring</a>
                                </div>
                            </div>
                            <!-- Welcome Thumbnail -->
                            <div class="col-12 col-md-6">
    ...
    <div class="col-md-2">
        ...
        <div class="col-md-8">
               <div class="about-us-content mb-80">
                    <p>        Whether you sell or buy drugs, guns, stolen credit cards, carding equipment, fake currency or other goods and services, you can use our secure bitcoin escrow to pay and receive payment.
<br>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-service-area mb-80">
                        ...
                        <h5>Drug Escrow</h5>
                        <p>Do you buy drugs online and you want to be covered? then worry no more, we got covered</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-service-area mb-80">
                        ...
                        <h5>Car Escrow</h5>
                        <p>Cars are expensive, we will cover you until your seller delivers your car to you. we pay him/her once you get the car</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-service-area mb-80">
                        ...
                        <h5>Documents Escrow</h5>
                        <p>Buy documents online with no stress, get your documents, test its authenticity before making payments.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-service-area mb-80">
                        ...
                        <h5>Jewelry Escrow</h5>
                        <p>Are you fun of expensive jewelries, are you afraid someone will take your money and not deliver? come let's cover your online purchase</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-service-area mb-80">
                        ...
                        <h5>Machinery Escrow</h5>
                        <p>Are you a company, do you deal with heavy machinery? then you are at the right place. our services cover all types of online transactions</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-service-area mb-80">
                        ...
                        <h5>Crypto-Currency Escrow</h5>
                        <p>Do you trade Crypto-Currency online? we can help you trade with peace of mind and make you sure you get your money whether you are buying or selling </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-blog-post bg-img mb-80" style="background-image: url(./img/bg-img/8.jpg);">
                        ...
                        <div class="post-content">
                            ...
                            <a href="#" class="post-title">Escrow: How do i make payment</a>
                            <p>Unique escrow accept bitcoin and paypal, we are descrete. once you make payment, the money shows up in your account</p>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-blog-post bg-img mb-80" style="background-image: url(./img/bg-img/9.jpg);">
                        ...
                        <div class="post-content">
                            ...
                            <a href="#" class="post-title">What If the seller does deliver</a>
                            <p>When you are creating an escrow transaction with us, we ask you to give us the refund address. once the seller does deliver, we refund you</p>
                            <a href="#" class="read-more-btn">Read More <i class="arrow_carrot-2right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-blog-post bg-img mb-80" style="background-image: url(./img/bg-img/10.jpg);">
                        ...
                        <div class="post-content">
                            ...
                            <a href="#" class="post-title">How long will it take you to refund me?</a>
                            <p>Refunds on unique escrow are instan, once you open a dispute we verify with you seller and refund you immediately</p>
                            <a href="#" class="read-more-btn">Read More <i class="arrow_carrot-2right"></i></a>
                        </div>
                    </div>
                </div>
